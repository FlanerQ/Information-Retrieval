...
template <class Funct> class Closure0 : public ClosureInterface {
  public:
    Closure0(Funct fun) { fun_ = fun; }
    virtual ~Closure0() {}
    virtual void Run() { (*fun_)(); }

  private:
    Funct fun_;
};

template <class Funct, class Arg1> class Closure1 : public ClosureInterface {
  public:
...
class Closure2 : public ClosureInterface {
  public:
    ...
    virtual ~Closure2() {}
    virtual void Run() { (*fun_)(arg1_, arg2_); }
...
class Closure3 : public ClosureInterface {
  public:
    ...
    virtual ~Closure3() {}
    virtual void Run() { (*fun_)(arg1_, arg2_, arg3_); }
...
template <class Obj, class Funct> class ObjClosure0 : public ClosureInterface {
  public:
...
class ObjClosure2 : public ClosureInterface {
  public:
    ...
    virtual ~ObjClosure2() {}
    virtual void Run() { (p_->*fun_)(arg1_, arg2_); }
...
class ObjClosure3 : public ClosureInterface {
  public:
    ...
    virtual ~ObjClosure3() {}
    virtual void Run() { (p_->*fun_)(arg1_, arg2_, arg3_); }
...
template <class R> ClosureInterface *NewClosure(R (*fun)()) {
...
ClosureInterface *NewClosure(R (*fun)(Arg1, Arg2, Arg3), Arg1 arg1, Arg2 arg2,
                             Arg3 arg3) {
    return new Closure3<R (*)(Arg1, Arg2, Arg3), Arg1, Arg2, Arg3>(fun, arg1,
                                                                   arg2, arg3);
}
...
ClosureInterface *NewClosure(Obj *obj, R (Obj::*fun)(Arg1, Arg2), Arg1 arg1,
                             Arg2 arg2) {
    return new ObjClosure2<Obj, R (Obj::*)(Arg1, Arg2), Arg1, Arg2>(obj, fun,
                                                                    arg1, arg2);
}

template <class R, class Obj, class Arg1, class Arg2, class Arg3>
ClosureInterface *NewClosure(Obj *obj, R (Obj::*fun)(Arg1, Arg2, Arg3),
